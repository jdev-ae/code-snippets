...
public class Way2SMS {
    ...
    public String loginWay2SMS(String userName, String password) {
        ...
        try {
            ...
            loginConnection.setRequestProperty("Content-Length",
                    String.valueOf(loginContent.length()));
            ...
            PrintWriter printWriter = new PrintWriter(
                    new OutputStreamWriter(loginConnection.getOutputStream()),
                    true);
    ...
    public void sendSMS(String phoneNumber, String message, String action) {
        ...
        try {
            ...
            sendContent = "custid=undefined&HiddenAction=instantsms&Action="
                    + action + "&login=&pass=&MobNo=" + phoneNumber
                    + "&textArea=" + message;
            ...
            sendConnection.setRequestProperty("Content-Type",
                    "application/x-www-form-urlencoded");
            ...
            PrintWriter printWriter = new PrintWriter(
                    new OutputStreamWriter(sendConnection.getOutputStream()),
                    true);
            ...
            BufferedReader bufferedReader = new BufferedReader(
                    new InputStreamReader(sendConnection.getInputStream()));
            ...
            if (SendResult.toString().contains(
                    "Message has been submitted successfully")) {
                System.out.println(
                        "Message sent to " + phoneNumber + " successfully.");
            } else {
                System.err.println(
                        "Message could not send to " + phoneNumber
    ...
    public static void main(String args[]) {  
        ...
        if (args.length > 0) {
            if (args[0].toLowerCase().compareTo("phone") == 0) {
                ...
                System.out.println(
                        "USAGE : Way2SMS phone <phonenumber1> <phonenumber2> ... message <message>");
                System.exit(0);
            }
        } else {
            System.out.println(
